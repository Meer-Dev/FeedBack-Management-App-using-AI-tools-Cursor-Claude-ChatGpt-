...
export class FileUploadServiceProxy {
    ...
    uploadFile(file: File | undefined): Observable<string> {
        let url_ = this.baseUrl + "/FileUpload/UploadFile"; // ✅ FIX: Use controller route, not AppService
        url_ = url_.replace(/[?&]$/, "");
        ...
        // ✅ FIX: Use HttpClient directly for file upload with proper headers
        return this.http.post(url_, formData, {
            responseType: 'text' // Expect string response
        }).pipe(
            _observableMergeMap((response: any) => {
                try {
                    // Parse the JSON response
                    const result = JSON.parse(response);
                    return _observableOf(result.fileUrl || '');
                } catch (e) {
            ...
            _observableCatch((response_: any) => {
                if (response_ instanceof HttpErrorResponse) {
                    return throwException("File upload failed", response_.status, response_.message, response_.headers);
                } else {
...
export class CourseServiceProxy {
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<CourseDto> {
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CourseDtoPagedResultDto> {
...
export class DashboardServiceProxy {
    ...
    getStatistics(): Observable<DashboardStatisticsDto> {
        let url_ = this.baseUrl + "/api/services/app/Dashboard/GetStatistics";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetStatistics(response: HttpResponseBase): Observable<DashboardStatisticsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getTopCoursesByRating(count: number | undefined): Observable<TopCoursesDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Dashboard/GetTopCoursesByRating?";
        if (count === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTopCoursesByRating(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTopCoursesByRating(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TopCoursesDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TopCoursesDto[]>;
        }));
    }

    protected processGetTopCoursesByRating(response: HttpResponseBase): Observable<TopCoursesDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(TopCoursesDto.fromJS(item));
            }
            else {
...
export class FeedbackServiceProxy {
     ...
     * @return OK
     */
    create(body: CreateUpdateFeedbackDto | undefined): Observable<FeedbackDto> {
        let url_ = this.baseUrl + "/api/services/app/Feedback/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<FeedbackDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: CreateUpdateFeedbackDto | undefined): Observable<FeedbackDto> {
        let url_ = this.baseUrl + "/api/services/app/Feedback/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<FeedbackDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<FeedbackDto> {
        let url_ = this.baseUrl + "/api/services/app/Feedback/Get?";
        if (id === null)
            throw new globalThis.Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<FeedbackDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, courseId: number | undefined, minRating: number | undefined, maxRating: number | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<FeedbackDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Feedback/GetAll?";
        if (keyword === null)
            throw new globalThis.Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        if (maxRating === null)
            throw new globalThis.Error("The parameter 'maxRating' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<FeedbackDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FeedbackDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<FeedbackDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FeedbackDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Feedback/Delete?";
        if (id === null)
            throw new globalThis.Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CreateUpdateFeedbackDto implements ICreateUpdateFeedbackDto {
    id!: number;
    studentName!: string;
    courseId!: number;
    ...
    constructor(data?: ICreateUpdateFeedbackDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): CreateUpdateFeedbackDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateUpdateFeedbackDto();
        result.init(data);
        return result;
    }
...
export interface ICreateUpdateFeedbackDto {
    id: number;
    studentName: string;
    courseId: number;
    comment: string | undefined;
...
export class DashboardStatisticsDto implements IDashboardStatisticsDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.totalFeedbacks = _data["totalFeedbacks"];
            this.totalCourses = _data["totalCourses"];
            this.activeCourses = _data["activeCourses"];
...
export class FeedbackDto implements IFeedbackDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.comment = _data["comment"];
            this.rating = _data["rating"];
            this.createdDate = _data["createdDate"] ? moment(_data["createdDate"].toString()) : undefined as any;
            this.fileUrl = _data["fileUrl"];
        }
    }
...
export class FeedbackDtoPagedResultDto implements IFeedbackDtoPagedResultDto {
    items!: FeedbackDto[] | undefined;
    totalCount!: number;

    constructor(data?: IFeedbackDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): FeedbackDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new FeedbackDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): FeedbackDtoPagedResultDto {
        const json = this.toJSON();
        let result = new FeedbackDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IFeedbackDtoPagedResultDto {
    items: FeedbackDto[] | undefined;
    totalCount: number;
}
...
export class TopCoursesDto implements ITopCoursesDto {
    courseId!: number;
    courseName!: string | undefined;
    instructorName!: string | undefined;
    averageRating!: number;
    ...
    constructor(data?: ITopCoursesDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): TopCoursesDto {
        data = typeof data === 'object' ? data : {};
        let result = new TopCoursesDto();
        result.init(data);
        return result;
    }
...
export interface ITopCoursesDto {
    courseId: number;
    courseName: string | undefined;
    instructorName: string | undefined;
    averageRating: number;
