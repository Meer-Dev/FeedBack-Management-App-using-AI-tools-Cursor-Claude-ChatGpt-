...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Dashboard'), '/app/dashboard', 'fas fa-chart-line'),
            new MenuItem(this.l('Courses'), '/app/courses', 'fas fa-book', 'Pages.Courses'),
            new MenuItem(this.l('Feedbacks'), '/app/feedbacks', 'fas fa-comments', 'Pages.Feedbacks'),
