...
namespace CourseFeedbackSystem.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = CourseFeedbackSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(CourseFeedbackSystemDbContext context)
    {
        _context = context;
    }
