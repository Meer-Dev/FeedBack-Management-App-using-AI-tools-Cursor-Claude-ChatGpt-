...
namespace CourseFeedbackSystem.Migrations
{
    ...
    [Migration("20251119155327_Add_TenantId_To_Course_And_Feedback")]
    partial class Add_TenantId_To_Course_And_Feedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseFeedbackSystem.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseFeedbackSystem.Feedbacks.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CourseFeedbackSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CourseFeedbackSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CourseFeedbackSystem.Feedbacks.Feedback", b =>
                {
                    b.HasOne("CourseFeedbackSystem.Courses.Course", "Course")
                        .WithMany()
