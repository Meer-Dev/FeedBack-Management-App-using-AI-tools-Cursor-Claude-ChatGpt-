...
using CourseFeedbackSystem.Models.TokenAuth;
...
public abstract class CourseFeedbackSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static CourseFeedbackSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseFeedbackSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<CourseFeedbackSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<CourseFeedbackSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<CourseFeedbackSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<CourseFeedbackSystemDbContext, Task<T>> func)
    {
        T result;
